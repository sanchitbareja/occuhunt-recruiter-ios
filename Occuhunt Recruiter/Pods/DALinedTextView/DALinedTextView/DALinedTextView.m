...
#define DEFAULT_VERTICAL_COLOR    [UIColor colorWithRed:52/255.0 green:136/255.0 blue:140/255.0 alpha:0.7f]
#define DEFAULT_HORIZONTAL_COLOR      [UIColor colorWithRed:220/255.0 green:220/255.0 blue:220/255.0 alpha:0.7f]
...
- (void)drawRect:(CGRect)rect
{
    ...
    if (self.horizontalLineColor)
    {
        ...
        {
            CGFloat linePointY = (baseOffset + (34 * line));
